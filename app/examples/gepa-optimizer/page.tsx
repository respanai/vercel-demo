...
import { GepaOptimizerSection } from "../sections/GepaOptimizerSection";
    ...
    <div className="min-h-screen bg-white text-black font-sans">
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">GEPA Prompt Optimizer</h1>
            <p className="text-xs text-gray-600 mt-2">
              Auto-optimize prompts using evolutionary search with LLM reflection and Pareto selection.
            </p>
          </div>
          <a
        ...
        <GepaOptimizerSection keywordsaiApiKey={keywordsaiApiKey} />
      </div>
    </div>
  );
}
